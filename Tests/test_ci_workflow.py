...
BOOTSTRAP_SCRIPT = ROOT / "Application/Dopamine/Resources/download_bootstraps.sh"
BOOTSTRAP_CHECKSUMS = (
...
class StrictMacOSWorkflowTests(unittest.TestCase):
    ...
    def test_bootstrap_downloads_are_verified(self):
        ...
        self.assertIn("shasum -a 256 -c bootstrap-sha256sums.txt", script)
    ...
    def test_artifact_is_validated_and_retained(self):
        for required in (
            ...
            self.assertIn(required.replace("¤", "$"), self.workflow)
